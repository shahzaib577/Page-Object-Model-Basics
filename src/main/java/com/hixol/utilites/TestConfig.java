package com.hixol.utilites;
public class TestConfig{


	
	public static String server="smtp.gmail.com";
	public static String from = "shazuvirk@gmail.com";
	public static String password = "Shazibgmail9700";
	public static String[] to ={"shazuvirk@gmail.com"};
